...
public class BBSClubListServlet extends HttpServlet {
	...
	private web.BBSList readDB(int upperSeqNo) throws ServletException {
		...
		try{
			...
			ResultSet rs = stmt.executeQuery("select * from bbs where type='동아리' and seqNo < " + upperSeqNo + " order by seqno desc; ");
