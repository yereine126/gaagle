...
public class BBSBookListServlet extends HttpServlet {
	...
	private web.BBSList readDB(int upperSeqNo) throws ServletException {
		...
		try{
			...
			ResultSet rs = stmt.executeQuery("select * from bbs where type='중고책' and seqNo < " + upperSeqNo + " order by seqno desc; ");
