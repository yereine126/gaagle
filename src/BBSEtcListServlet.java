...
public class BBSEtcListServlet extends HttpServlet {
	...
	private web.BBSList readDB(int upperSeqNo) throws ServletException {
		...
		try{
			...
			ResultSet rs = stmt.executeQuery("select * from bbs where type='기타' and seqNo < " + upperSeqNo + " order by seqno desc; ");
